...
class ExamplePlugin extends runtime_1.Plugin {
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            router.post('/cloudwatch/:space', (req, res) => __awaiter(this, void 0, void 0, function* () {
                res.send({
                    key
                });
            }));
            ...
            clustermgr.addMetricDriver('cloudwatch', metric_1.CloudwatchMetricDriver);
        });
    }
    deactivate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const clustermgr = this.context.getClusterManager();
            clustermgr.removeMetricDriver('cloudwatch');
        });
    }
}
